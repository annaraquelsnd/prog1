...
int main(){
    ...
    for (cont = 0; cont < n; cont++){
        ...
        if(ditanciaEntrePontos(ponto, reta.inicio) > ditanciaEntrePontos(ponto, reta.fim)){
            printf("FIM\n");
        } else if (ditanciaEntrePontos(ponto, reta.inicio) < ditanciaEntrePontos(ponto, reta.fim)){
            printf("INICIO\n");
        } else {
            printf("EQUIDISTANTE\n");
        }
